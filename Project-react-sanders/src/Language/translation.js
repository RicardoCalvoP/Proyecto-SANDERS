export const spanishMessages = {
    ra: {
        action: {
            ...
            add: 'Agregar',
            back: 'Regresar',
            bulk_actions: '1 artículo seleccionado |||| %{smart_count} artículos seleccionados',
            cancel: 'Cancelar',
            ...
            move_down: 'Bajar',
            open: 'Abrir',
            toggle_theme: 'Cambiar entre modo claro/oscuro',
        ...
        input: {
            file: {
                upload_several: 'Arrastra varios archivos para subir, o haz clic para seleccionar uno.',
                upload_single: 'Arrastra un archivo para subir, o haz clic para seleccionarlo.',
            },
            image: {
                upload_several: 'Arrastra varias imágenes para subir, o haz clic para seleccionar una.',
        ...
        message: {
            ...
            bulk_delete_content: '¿Estás seguro de que quieres eliminar %{name}? |||| ¿Estás seguro de que quieres eliminar estos %{smart_count} artículos?',
            bulk_delete_title: 'Eliminar %{name} |||| Eliminar %{smart_count} %{name}',
            bulk_update_content: '¿Estás seguro de que quieres actualizar %{name}? |||| ¿Estás seguro de que quieres actualizar estos %{smart_count} artículos?',
            ...
            details: 'Detalles',
            error: 'Ocurrió un error en el cliente y no se pudo completar tu solicitud.',
            invalid_form: 'El formulario no es válido. Por favor revisa si hay errores',
            loading: 'Por favor espera',
            no: 'No',
            not_found: 'O escribiste mal la URL, o seguiste un enlace incorrecto.',
            yes: 'Sí',
            unsaved_changes: 'Algunos de tus cambios no se guardaron. ¿Estás seguro de que quieres ignorarlos?',
        },
        navigation: {
            clear_filters: 'Limpiar filtros',
            no_filtered_results: 'No se encontró ningún %{resource} usando los filtros actuales.',
            no_results: 'No se encontró ningún %{resource}',
            no_more_results: 'El número de página %{page} está fuera de los límites. Prueba con la página anterior.',
        ...
        auth: {
            ...
            sign_in_error: 'Error de autenticación, intenta de nuevo',
